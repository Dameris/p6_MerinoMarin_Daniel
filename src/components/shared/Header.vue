<template>
  <header>
    <div class="header__top">
      <nav>
        <ul class="header__list">
          <li>
            <router-link to="favorites" class="header__links"> FAVORITES </router-link>
          </li>
          <li>
            <router-link to="about-us" class="header__links"> ABOUT US </router-link>
          </li>
        </ul>
      </nav>
      <router-link to="/">
        <img src="../img/logo_infoDisney.png" alt="InfoDisney Logo" class="header__logo" />
      </router-link>
      <nav>
        <ul class="header__list">
          <li>
            <router-link to="logIn" class="btn__logIn"> LOG IN </router-link>
          </li>
          <li>
            <router-link to="signUp" class="btn__signUp"> SIGN UP </router-link>
          </li>
        </ul>
      </nav>
    </div>
    <div class="headerBottom">
      ...
      <label for="__btn__switch" class="btn__switch" />
